...
class Miniterm(object):
    ...
    def close(self):
        self.serial.close()
        self.logger.append(self.log)
        #pprint(self.logger)
        out={}	
        out['BusPirateLoggerVersion']='1'
        out['log']=self.logger[1:]
    ...
    def reader(self):
        ...
        try:
            while self.alive and self._reader_alive:
                ...
                if data:
                    self.log['result']=self.log['result']+data.decode()
                    if self.raw:
            ...
            while self.alive:
                ...
                if menu_active:
                    ...
                    if text is "\n":
                        ...
                        self.log={}
                        self.log['result']=''
                        self.log['command']=self.logcommand						
                        self.logcommand=''
                    else:
                        self.logcommand=self.logcommand+text
